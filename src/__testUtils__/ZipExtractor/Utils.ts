...
export const setUp = (files: { zipFilePath: string; textFilePath: string }) => {
...
export const cleanUp = (zipFilePath: string, textFilePath: string) => {
  const files = [zipFilePath, textFilePath];
